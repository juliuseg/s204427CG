var gl, program;
var M_texLoc, mvpMatrixLoc, lightDirLoc, isBackgroundLoc;
var canvas;
...
window.onload = function init() {
    ...
    camera = new Camera(
        ...
        lightFollowFactor = 0.5 // Light follows halfway the camera
    );
    ...
    // Set up a light direction for the shader
...
function render(currentTimestamp) {
    // Changes since last: Conditional rendering for sphere and background with buffer rebinding
